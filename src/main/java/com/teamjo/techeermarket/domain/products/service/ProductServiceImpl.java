...
//    private final ChatRoomRepository chatRoomRepository ;
    ...
    public Long saveProduct(ProductRequestDto request, String email) throws IOException {
        ...
        if (!imageUrls.isEmpty()) {
            products.setThumbnail(imageUrls.get(0));    // objmeta 를 적용해서 리사이징 된 파일 저장하는 로직으로 수정
        }
...
//            chatRoomRepository.deleteByProducts(products);
    ...
    public Long updateProduct(Long productId, ProductRequestDto updateRequest, String email) throws IOException {
        ...
        List<String> imageUrls = s3ServiceImpl.uploadProductImageList(BucketDir.PRODUCT, imageFiles);
     ...
     */
    @Override
    public void setProductImg(Products products, List<String> imageUrls, Long newProductID) {
